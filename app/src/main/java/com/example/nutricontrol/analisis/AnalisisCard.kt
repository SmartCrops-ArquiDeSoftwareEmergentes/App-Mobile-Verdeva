package com.example.nutricontrol.analisis
...
fun AnalisisCard(
    title: String,
    estimaciones: List<String>,
    riesgos: List<String>,
    predicciones: List<String>,
